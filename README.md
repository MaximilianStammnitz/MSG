...
* [Manta v1.6.0 (dev branch)](https://github.com/MaximilianStammnitz/MSG/blob/master/manta-1.6.0.centos6_x86_64.tar.bz2)
...
* [Graphtyper v2.5.1 (dev branch)](https://github.com/DecodeGenetics/graphtyper/releases/tag/v2.5.1)
